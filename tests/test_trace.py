...
def test_read_xxx():
    ...
    # jsn = trace.read_json('tests/data/2-178-withfeed.rgp')
    # jsn['settings'].pop('raw')
    # pdc = trace.read_pdc('tests/data/2-178-withfeed.pdc')
...
def test_Trace():
    tr = trace.Trace()
    trfns_resiId_hash = (
        ('tests/data/1-131-withfeed-json.rgp', 'some-identifier', 'f7016732bd8bd193fd4a97712acae86b'),
